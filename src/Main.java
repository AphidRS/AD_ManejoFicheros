            ...
            switch (opcion) {
                ...
                case 3: 
                    ...
                    if (cocheConsultado != null) {
                        System.out.println("");
                        System.out.println("[Info] Consulta ID: " + cocheConsultado.getId() + " - Matrícula: " + cocheConsultado.getMatricula() + " - Marca: " + cocheConsultado.getMarca() + " - Modelo: " + cocheConsultado.getModelo() + " - Color: " + cocheConsultado.getColor());
                        System.out.println("");
                    } else {
                ...
                case 6:
                    ...
                    System.out.println("");
                    break;
                default: System.out.println("[Warning] Opción no válida, por favor seleccione una opción del menú.");break;
            }
        }
        scanner.close();
    }
